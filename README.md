...
2. **Сервер**. Программа принимает изображение и полигоны от клиента, детектирует объекты на изображении, создаёт бинарные маски полигонов, ищет полигоны, пересекающиеся с объектом, смотрит количество пикселей в области пересечения и в зависимости от правил (основанных на площади пересечения) обводит объект или игнорирует. Итоговое изображение отправляет обратно клиенту.
