...
**Warning**
В серверной части предусмотренно кеширование полигонов. Временно оно реализованно через имя файла с полигонами, в дальнейшем планируется реализация черех высчитывания хэша полигонов. Поэтому, новые наборы полигонов лучше сохранять с разными именами файлов.
